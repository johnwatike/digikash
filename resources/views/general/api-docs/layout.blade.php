...
<head>
    ...
    <title>@yield('title', __('API Documentation')) | {{ setting('site_title') }}</title>
    <meta name="description" content="@yield('description', __('Comprehensive API documentation for ' . setting('site_title') . ' payment gateway integration'))">
