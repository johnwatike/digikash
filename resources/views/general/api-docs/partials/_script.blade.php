<script>
    ...
    /**
     * {{ setting('site_title') }} API Documentation JavaScript
    ...
    class APIDocumentation {
        ...
        init() {
            ...
            console.log('{{ setting("site_title") }} API Documentation initialized successfully');
        }
    ...
    function copyToClipboard(button) {
        const endpoint = button.previousElementSibling.textContent;
