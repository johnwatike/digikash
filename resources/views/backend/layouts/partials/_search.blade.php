<form class="d-none d-md-flex align-items-center position-relative admin-menu-search-form" role="search" id="admin-menu-search-form">
    ...
    <div id="admin-menu-search-results" class="admin-menu-search-results position-absolute top-100 start-0 bg-white border border-light-subtle rounded-bottom shadow-lg d-none">
        <div class="p-2">
