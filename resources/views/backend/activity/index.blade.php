                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-md me-2">
                                        @isset($activity->user->avatar)
                                            <img class="avatar-img" src="{{ asset($activity->user->avatar) }}" height="40" alt="User Avatar" loading="lazy">
                                        @else
                        ...
                        <tr>
                            <td colspan="5">
                                <x-admin-not-found
                                    ...
                                    :message="__('Login activity matching the current filters will appear here.')"
                                    icon="fa-clock"
                                />
                            </td>
                        </tr>
