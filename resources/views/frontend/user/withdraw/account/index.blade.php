...
@section('content')
    <div class="single-form-card">
        <x-user-feature-header
            ...
            :subtitle="__('Manage your saved withdrawal destinations.')"
        ...
        <div class="card-main bg-main">
                ...
                <div class="withdraw-account-item d-flex align-items-center justify-content-between p-2 rounded mb-2 bg-white border-default">
                    <div class="circle-icon d-flex align-items-center justify-content-center me-2">
                        <img class="img-fluid" src="{{ asset($account->withdrawMethod->logo) }}"
                             alt="{{ __('Withdraw Method Logo') }}" loading="lazy">
                    </div>
            ...
            @empty
                <x-user-not-found
                    :title="__('No withdraw accounts found')"
                    :message="__('Create a withdrawal account to save your payout destination before requesting funds.')"
                    icon="fa-building-columns"
                    :action-url="route('user.withdraw.account.create')"
                    :action-label="__('Create Account')"
