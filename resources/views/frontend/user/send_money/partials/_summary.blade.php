<div class="col-lg-12 col-xl-5">
    <div class="single-form-card">
        <x-user-feature-header
            :title="__('Summary')"
            :subtitle="__('Confirm totals and balance changes before you send the transfer.')"
            icon="fas fa-chart-line"
            compact
        />
        <div class="card-main">
            <ul class="summery-list list-unstyled">
                <li class="d-flex justify-content-between"><span>{{ __('Amount') }}</span><span
                ...
                <li class="d-flex justify-content-between">
                    <strong>{{ __('Recipient Wallet Added') }}</strong><strong
                            class="recipient-wallet-added"></strong></li>
                <li class="d-flex justify-content-between">
                    <strong>{{ __('My Wallet Decreased') }}</strong><strong
