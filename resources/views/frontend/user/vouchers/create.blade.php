...
@section('content')
    <div class="row">
        <div class="col-lg-7">
            <div class="single-form-card">
                <x-user-feature-header
                    :title="__('Create Voucher')"
                    :subtitle="__('Issue a voucher from one of your wallets in a few steps.')"
        ...
        <div class="col-lg-5">
            <div class="single-form-card">
                <x-user-feature-header
                    :title="__('Voucher Summary')"
                    :subtitle="__('Preview the amount and wallet impact before generating.')"
