    ...
    <div class="auth-shell">
        <div class="auth-card has-accent is-merchant">
            ...
            <div class="auth-head">
                ...
                <h4 class="auth-title">{{ __('Set New Merchant Password') }}</h4>
                <p class="auth-subtitle">@lang('Enter and confirm a new password for your merchant account.')</p>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control"
                               placeholder="@lang('Enter your merchant email')"
