...
@section('title', __('Set New Merchant Password'))
	...
	<section class="shell">
		<div class="form-panel">
			...
			<div class="form-body">
				...
				<form action="{{ route('merchant.password.store') }}" method="POST" novalidate>
					@csrf
					...
					<div class="form-footer">
						<a href="{{ route('merchant.login') }}" class="gold-link">{{ __('Back to Sign In') }}</a>
					</div>
				</form>
			</div>
		</div>
