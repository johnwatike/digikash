...
class PageComponentRepeatedContentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $fieldDefinitions = PageComponent::contentFields($component->component_key, 'repeated_content', $component->theme);
    ...
    public function edit($id)
    {
        ...
        $repeatedFieldDefinitions = PageComponent::contentFields($component->component_key, 'repeated_content', $component->theme);
