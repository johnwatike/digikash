...
class PageComponentController extends BaseController
{
    ...
    public function create()
    {
        ...
        $fieldDefinitions = PageComponent::contentFields('dynamic', 'component_fields', activeTheme());
    ...
    public function edit($id)
    {
        ...
        $componentTheme   = $component->theme ?? Theme::default();
        $fieldDefinitions = PageComponent::contentFields($componentKey, 'component_fields', $componentTheme);
