...
class Wallet extends Model
{
    ...
    public function receiveMoneyUrl(): string
    {
        return route('user.send-money.create', ['recipient' => $this->uuid]);
    }

    public function receiveMoneyQrCodeSvg(int $size = 220): string
    {
        return app(QRCodeService::class)->generate($this->receiveMoneyUrl(), $size);
    }
