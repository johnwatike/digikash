...
class VirtualCardRequest extends Model
{
    ...
    /**
     * Get the cardholder profile attached to this request. Used by the
     * admin review flow to filter the provider dropdown to those that
     * support the cardholder's billing country.
     */
    public function cardholder()
    {
        return $this->belongsTo(Cardholders::class, 'cardholder_id');
    }
